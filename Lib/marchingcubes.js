 ...
 *  slighly modified by Arkajit for viewing extended Huckel
 */
...
marchingCubes = function(dims, potential, bounds) {
  ...
  try {postMessage({'msg':'obtaining MO surface','prg':50*(x[2]/(dims[2]-1))});} catch (error) {console.log(50*(x[2]/(dims[2]-1)));}
